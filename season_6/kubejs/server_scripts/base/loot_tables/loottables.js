LootJS.modifiers(event => {
	event.addLootTableModifier('chests/village/village_weaponsmith', 'chests/abandoned_mineshaft', 'chests/ancient_city', 'chests/buried_treasure', 'chests/shipwreck_treasure').pool(pool => {
        pool.rolls([1, 3])
