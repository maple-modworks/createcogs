ServerEvents.recipes((event) => {
  ...
  event.recipes.create.emptying([Fluid.of('kubejs:nuclear_waste', 1000), 'minecraft:barrel'], 'cogutilities:waste_barrel'),
  ...
  event.recipes.createFilling('cogutilities:waste_barrel', [Fluid.of('kubejs:nuclear_waste', 1000), 'minecraft:barrel'])
})