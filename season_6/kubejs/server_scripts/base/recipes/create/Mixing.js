ServerEvents.recipes((event) => {
	...
	event.recipes.createMixing('davebuildingmod:steel_ingot', [
		Fluid.of('kubejs:molten_steel', 250)
	]),
	event.recipes.createMixing([Fluid.of('kubejs:steel_blend', 250)], [
		'create:crushed_raw_iron',
		'kubejs:graphite_dust'
	]),
	event.recipes.createMixing([Fluid.of('kubejs:steel_blend', 750)], [
		'2x create:crushed_raw_iron',
		'3x minecraft:coal'
	]),
	event.recipes.createMixing([Fluid.of('kubejs:crimson_essence', 250)], [
		'2x minecraft:clay_ball',
		Fluid.of('minecraft:lava', 250),
		'2x minecraft:glowstone_dust',
		'3x minecraft:redstone'
	]),
	event.recipes.createMixing('minecraft:redstone', [
