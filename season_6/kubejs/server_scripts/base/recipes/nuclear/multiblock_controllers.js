ServerEvents.recipes(event => {
	...
	event.shaped('mbd2:steam_turbine', [
		'APA',
		'TBT',
		'CIC'
	], {
	...
	event.shapeless('mbd2:rotation_output', [
	'mbd2:turbine_fan']),
	event.shapeless('mbd2:turbine_fan', [
	'mbd2:rotation_output'])
	event.shaped('mbd2:steam_vent', [
		' P ',
		' T ',
		' C '
	], {
	...
	event.shaped('mbd2:nuclear_boiler', [
		'TPT',
		'CBC',
		'PPP'
	], {
	...
	event.shaped('mbd2:hydraulic_press', [
		'GPG',
		'FTF',
		'CCC'
	], {
